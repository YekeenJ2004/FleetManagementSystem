...
class TestVehicleManager:
    ...
    def test_update_vehicle(self):
        ...
        self.vehicle_manager.add_vehicle(self.sample_vehicle)
        self.vehicle_manager.update_vehicle(self.sample_vehicle.reg_number, TaxStatus="Unpaid", FuelType="Diesel")
        result = self.vehicle_manager.search_vehicles(
            "SELECT TaxStatus, FuelType FROM Vehicles WHERE RegistrationNumber = ?",
